...
export const questions = [
  {
    ...
    answer: (
      <>
        ...
        <Text as="p" size="xl" className="decorator decorator_indent-b_m">
          Это может быть интранет, личный кабинет, инструмент для мониторинга какой-либо системы,
  ...
  {
    title: 'Можем ли мы использовать Consta, если у нас готовый продукт «из коробки»?',
    answer: (
      <>
        <Text as="p" size="xl" className="decorator decorator_indent-b_m">
          Это зависит от вашего проекта и от решения, которое вы используете. Есть два варианта:
          создать свой веб-интерфейс для коробочного продукта или настроить то, как он выглядит
        </Text>
        <Text as="p" size="xl" weight="bold">
          Создать свой веб-интерфейс
        </Text>
        <Text as="p" size="xl" className="decorator decorator_indent-b_m">
          Для некоторых готовых решений можно создать свой веб-интерфейс на дизайн-системе Consta
          (например, у 1С, Bitrix и QlikSense есть API, который это позволяет). Это большая задача,
          её стоит планировать, если у сервиса много пользователей, вам очень важно качество
          пользовательского опыта и удобный интерфейс. Например, если это дашборд или личный кабинет
          сотрудника в большой компании.
        </Text>
        <Text as="p" size="xl" weight="bold">
          Настроить внешний вид
        </Text>
        <Text as="p" size="xl">
          У других готовых решений настраивается интерфейс (например, у QlikView и Terrasoft). В
          этом случае дизайн-систему не получится использовать полностью, но на неё можно опираться
